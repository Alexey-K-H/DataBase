...
public class StudentModify extends CategoryModify {

    public StudentModify(TableController tableController, ArrayList<String> currValues, DefaultTableModel tableModel, int indexRow) {
    ...
    public void openModifyWindow() {
        ...
        this.setTitle("Изменение данных студента");
        ...
        JLabel info = new JLabel("Введите новые данные студента");
