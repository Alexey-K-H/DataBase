package gui.queryWindow.query9;
...
public class NinthQuery extends QueryFrame {

    public NinthQuery(QueryController queryController) {
    ...
    public void openQueryConfig() {
        ...
        this.setTitle("Выработка библиотекарей");
        ...
        JButton find = new JButton("Получить выработку");
        ...
        find.addActionListener(e -> {
            ...
            if(beginDate.isEmpty() || endDate.isEmpty()){
                ...
                String queryStr = "with t1 as (\n" +
                        ...
                        "      and DATE_OF_ISSUE <= TO_DATE('"+ endDate +"','dd.mm.yyyy')\n" +
